    ...
    public void creditQuery() {
        ...
        for(int i=0;i<1;i++) {
            StopWatch watch = StopWatch.
                    createStarted();
            try {
                Object data = protocol.creditQuery(contractId, transactionId, name, idNumber, true, l);
...
public Object query(String contractId,
     ...
     * 二要素信用凭证查询
     * @param contractId 合约
     * @param transactionId 交易订单
     * @param name 用户姓名
     * @param idNumber 用户身份证号码
     * @param continuePriceQuery 是否支持查询用户详细名单信息
     * @param requestedRandom 用户随机码
     * @return 返回用户信用凭证查询结果
     */
    public Object creditQuery(
            String contractId, String transactionId, String name, String idNumber, boolean continuePriceQuery, long requestedRandom);
    /**
     * 三要素信用凭证查询
     * @param contractId 合约
     * @param transactionId 交易订单
     ...
     * @param continuePreciseQuery 是否支持查询用户详细名单信息
     * @param requestedRandom 用户随机码
     * @return 返回用户信用凭证查询结果
     */
    public Object creditQuery(
            String contractId,
            String transactionId, String name, String idNumber, String telephone, boolean continuePreciseQuery, long requestedRandom)
