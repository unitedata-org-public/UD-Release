...
--
-- Table structure for table `debt_xd`
--

DROP TABLE IF EXISTS `debt_xd`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `debt_xd` (
  `id` bigint(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '小贷债务ID',
  `name` varchar(255) DEFAULT NULL COMMENT '姓名',
  `idno` varchar(255) DEFAULT NULL COMMENT '身份证',
  `mobile` varchar(255) DEFAULT NULL COMMENT '手机号',
  `loanAmount` int(8) DEFAULT NULL COMMENT '贷款额度',
  `loanPeriod` int(8) DEFAULT NULL COMMENT '贷款期数',
  `surplusAmount` int(8) DEFAULT NULL COMMENT '剩余还款额度',
  `surplusPeriod` int(8) DEFAULT NULL COMMENT '剩余期数',
  `overdueAmount` int(8) DEFAULT NULL COMMENT '逾期未还金额',
  `overdueNumber` int(8) DEFAULT NULL COMMENT '逾期未还次数',
  `overduePaidAmount` int(8) DEFAULT NULL COMMENT '逾期已还次数',
  `overduePaidNumber` int(8) DEFAULT NULL COMMENT '逾期已还金额',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='小贷债务';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `debt_xfjr`
--

DROP TABLE IF EXISTS `debt_xfjr`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `debt_xfjr` (
  `id` bigint(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '消费金融债务ID',
  `name` varchar(255) DEFAULT NULL COMMENT '姓名',
  `idno` varchar(255) DEFAULT NULL COMMENT '身份证',
  `mobile` varchar(255) DEFAULT NULL COMMENT '手机号',
  `loanAmount` int(8) DEFAULT NULL COMMENT '贷款额度',
  ...
  `overduePaidNumber` int(8) DEFAULT NULL COMMENT '逾期已还金额',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='消费金融债务';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `debt_xjd`
--

DROP TABLE IF EXISTS `debt_xjd`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `debt_xjd` (
  `id` bigint(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '现金贷债务',
  `name` varchar(255) DEFAULT NULL COMMENT '姓名',
  `idno` varchar(255) DEFAULT NULL COMMENT '身份证',
  `mobile` varchar(255) DEFAULT NULL COMMENT '手机号',
  `loanAmount` int(8) DEFAULT NULL COMMENT '贷款额度',
  ...
  `overduePaidNumber` int(8) DEFAULT NULL COMMENT '逾期已还金额',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='现金贷债务';
/*!40101 SET character_set_client = @saved_cs_client */;
